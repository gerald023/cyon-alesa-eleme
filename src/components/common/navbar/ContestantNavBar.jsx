...
const navItems = [
  { id: 1, name: "Contestant", url: "contestant" },
  { id: 2, name: "All Contestants", url: "all-contestant" },
];
      ...
      <div className="navbar flex justify-between mx-auto content">
        <div className="flex items-center justify-between">
          ...
          >
            ...
            <p className="text-2xl sm:text-[32px] my-auto ms-3 font-semibold">
              CYON
            </p>
          </NavLink>
        </div>
