import { faCheckToSlot, faUserTie } from '@fortawesome/free-solid-svg-icons';
import cyon_bg from '../../assets/images/winner_img.png'
import ContestantSocialMedia from './ContestantSocials'
...
const workStepData = [
  {
    id: 1,
    title: "Meet Francis Ernest",
    description:
      "His hobbies are, playing football, singing, dancing, reading and praying.",
  ...
  },
  {
    ...
    title: "Votes",
    description:
      "So far, this contestant has gotten 240 votes, continue to support her.",
...
function OneContestant() {
  return (
    <>
          <div
      className="content -my-25 grid xl:grid-cols-2 xl:items-center px-2 py-5 md:py-10 lg:py-25 xl:py-35 max-xxl:px-4"
      id="contestant"
    >
       {/* Profile image */}
      ...
      <div className="grid xs:grid-cols-2 justify-end my-2 w-fit mx-auto ">
        {workStepData.map((data, index) => {
         ...
         <a
                  href={'#!'}
                  className="btn btn-primary py-7 px-6 mt-5 text-center text-[16px] font-semibold"
                >
