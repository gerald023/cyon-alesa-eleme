...
import cyon_bg from '../../assets/images/portfolio-images/cyon_sport_day.jfif'
    ...
    >
      <div className="flex max-md:flex-col justify-between items-center gap-6">
        ...
        <div className="max-sm:w-full w-132">
          ...
          >
            We are hosting our biggest End of the Year yet!!!
          </h2>
          <div
          ...
          <div className="mt-8 flex max-md:justify-center">
            ...
            <a
              ...
              href="#!"
            >
              <FontAwesomeIcon icon={faDownload} />Read More
            </a>
          </div>
        </div>
      </div>
